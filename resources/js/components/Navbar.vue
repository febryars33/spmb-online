        ...
        <div class="container">
            ...
            >
                ...
                <div class="offcanvas-body">
                    <ul
                        class="navbar-nav justify-content-lg-center flex-grow-1"
                    >
                        <li class="nav-item">
                            <Link
                        ...
                        <li class="nav-item">
                            <Link class="nav-link me-0 me-lg-2" :href="faq()"
                                >FAQ</Link
                            >
                        </li>
                        <li class="nav-item">
                            <Link class="nav-link" :href="check()"
                                >Cek Pendaftaran</Link
                            >
                        </li>
                    </ul>
                    <ul
                        v-if="page.props.auth.user"
                        class="navbar-nav justify-content-lg-end flex-grow-1"
                    >
                    ...
                    <div
                        v-if="!page.props.auth.user"
                        class="d-lg-flex col-lg-3 justify-content-lg-end mt-3 mt-lg-0"
                    >

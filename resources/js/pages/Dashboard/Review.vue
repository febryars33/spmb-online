                        ...
                        <div class="card shadow-sm rounded-4 border-0">
                            ...
                            <div class="card-body">
                                <p class="small mb-4">
                                    ...
                                    verifikasi terhadap data dan dokumen yang
                                    Anda unggah. Proses ini biasanya memakan
                        ...
                        <div class="card border-0 shadow-sm rounded-4 mb-4">
                            <div class="card-body p-4">
                                ...
                                <p class="small text-muted mb-4">
                                    ...
                                    status pendaftaran, silahkan hubungi panitia
                                    PPDB kami.
                                </p>
                        ...
                        <div class="card border-0 shadow-sm rounded-5 p-4">
                            ...
                            <div class="mb-3">
                                <small class="text-secondary d-block mb-1"
                                    >Nama Lengkap</small
                                ><span class="fw-bold small">Budi Santoso</span>
                            </div>
                            <div class="mb-3">
                                <small class="text-secondary d-block mb-1"
                                    >Tipe Pendaftaran</small
                                ><span class="fw-bold small">Siswa Baru</span>
                            </div>
                            <div class="mb-0">
                                <small class="text-secondary d-block mb-1"
                                    >Kelengkapan Berkas</small
                                >

<template>
    <div class="position-relative" ref="target">
        ...
        >
            <span class="text-truncate me-2">{{ selected?.name || 'Pilih Opsi' }}</span>
            <button type="button" class="btn-close" style="font-size: 0.65rem" @click.stop="onClear" />
        </div>
        ...
        >
            ...
            <div class="p-2">
                ...
                >
                    ...
                    />
                    <label class="form-check-label d-block w-100" :for="'radio-' + index">
                        {{ option.name }}
                    </label>
                </div>
            </div>

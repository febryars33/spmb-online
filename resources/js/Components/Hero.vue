                ...
                <div class="col-lg-6">
                    <div style="opacity: 1; transform: none">
                        ...
                        <h1 class="display-4 fw-bold mb-4">
                            Wujudkan Masa Depan Gemilang di <span class="text-primary">{{ $page.props.name }}</span>
                        </h1>
                        <p class="lead text-secondary mb-5">
                            Sekolah terbaik dengan fasilitas modern dan kurikulum internasional untuk mencetak pemimpin masa depan.
                        </p>
                        <div class="d-flex flex-wrap gap-3">
                            ...
                            <Link v-else class="btn btn-primary btn-lg px-5 rounded-pill shadow-lg hover-lift" :href="login()">
                                Daftar Sekarang
                            </Link>
                            <Link class="btn btn-outline-primary btn-lg px-5 rounded-pill hover-lift" :href="check()"> Cek Status </Link>
                        </div>
                        <div class="mt-5 d-flex align-items-center gap-4">
                            ...
                            <p class="small mb-0 text-secondary fw-bold">Bergabung dengan 1,200+ calon siswa lainnya</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="position-relative" style="opacity: 1; transform: none">
                        <img
                        ...
                        >
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <small class="text-secondary">Sertifikasi Nasional</small>
                                </div>
                            </div>
                        </div>
                    </div>
